...
public class LinkedList<E> {
	...
	/**
	 * Removes all occurrences of the specified element from this list, if
	 * it is present. Each time an element is removed, all subsequent elements are
	 * shifted to the left (subtracts one to their indices).
	 * 
